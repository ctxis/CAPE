rule CAPE_Dridex
{
    ...
    strings:
        ...
        $crypt_64 = {41 54 41 55 41 56 41 57 48 81 EC 48 02 00 00 49 89 CE 45 89 CC 4D 89 C5 41 89 D7 4D 85 F6 0F 84 41 02 00 00 45 85 FF 0F 84 38 02 00 00 4D 85 ED 0F 84 2F 02 00 00 45 85 E4 0F 84 26 02 00}
    ...
    condition:
        ...
        ($crypt_32_v1 or $crypt_32_v2 or $crypt_64)
}
